...
WHERE /*TMOV.CODCOLIGADA = @COD_COLIGADA
AND     TMOV.IDPRJ = @ID_PRJ
AND*/     TMOV.DATAEMISSAO >= '2012-08-01'
--AND     TITMMOV.IDTRF = 4091
AND    TMOV.STATUS <> 'C'
...
/* MOVIMENTO 1.1.40 E 1.1.41 INCLUIDOS NA EXCEÇÃO (PARA NÃO EXIBIR NOTAS NOVAMENTE) DIA 14/08/2024 RDM 0824-000508*/

AND    TMOV.CODTMV NOT IN ('1.1.21', '1.1.20', '1.1.25', '1.1.26', '1.1.34', '1.1.35','1.1.06','1.1.07','1.1.40','1.1.41')

GROUP BY TMOV.IDMOV, TMOV.NUMEROMOV, FCFO.NOME,TMOV.CODCOLIGADA ,TMOV.IDPRJ,TITMMOV.IDTRF,TMOV.DATACRIACAO) as A

--GROUP BY TMOV.IDMOV, TMOV.NUMEROMOV, FCFO.NOME,TMOV.CODCOLIGADA ,TMOV.IDPRJ,TITMMOV.IDTRF,TMOV.DATACRIACAO
